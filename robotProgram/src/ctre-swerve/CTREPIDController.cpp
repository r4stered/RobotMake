...
void CTREPIDController::SetP(double Kp)
{
    m_Kp = Kp;
}

void CTREPIDController::SetI(double Ki)
{
    m_Ki = Ki;
}

void CTREPIDController::SetD(double Kd)
{
    m_Kd = Kd;
}

double CTREPIDController::GetP() const
{
    return m_Kp;
}

double CTREPIDController::GetI() const
{
    return m_Ki;
}

double CTREPIDController::GetD() const
{
    return m_Kd;
}
...
double CTREPIDController::GetSetpoint() const
{
    return m_setpoint;
}
...
void CTREPIDController::EnableContinuousInput(double minimumInput,
                                              double maximumInput)
{
    m_continuous = true;
...
void CTREPIDController::DisableContinuousInput()
{
    m_continuous = false;
}
...
void CTREPIDController::SetIntegratorRange(double minimumIntegral,
...
void CTREPIDController::SetTolerance(double positionTolerance,
...
double CTREPIDController::GetPositionError() const
{
    return m_positionError;
}

double CTREPIDController::GetVelocityError() const
{
    return m_velocityError;
}

double CTREPIDController::Calculate(double measurement, double setpoint, units::second_t currentTimestamp)
{
    m_setpoint = setpoint;
    m_haveSetpoint = true;
...
double CTREPIDController::GetLastAppliedOutput()
{
    return m_lastAppliedOutput;
}
