...
SimSwerveDrivetrain::SimSwerveDrivetrain(ctre::phoenix6::hardware::Pigeon2 &pigeon) : pigeonSim{pigeon}
{
}
...
{
  wpi::array<frc::SwerveModulePosition, 4> positions{frc::SwerveModulePosition{}, frc::SwerveModulePosition{}, frc::SwerveModulePosition{}, frc::SwerveModulePosition{}};
  for (int i = 0; i < 4; i++)
  {
  ...
  frc::Twist2d change = constants::drivebase::kinematics::kinematics.ToTwist2d(positions);
