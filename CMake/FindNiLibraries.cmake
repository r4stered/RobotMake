...
find_library(CHIPOBJECT_LIBRARY
...
mark_as_advanced(CHIPOBJECT_HEADERS NETCOMM_HEADERS VISA_HEADERS CHIPOBJECT_LIBRARY NETCOMM_LIBRARY FPGASHIM_LIBRARY CANSHIM_LIBRARY VISA_LIBRARY)
...
if(NILIBRARIES_FOUND AND NOT TARGET nilibraries::nilibraries)
    ...
    PROPERTIES
        INTERFACE_INCLUDE_DIRECTORIES ${CHIPOBJECT_HEADERS}
    ...
    netcomm::netcomm
    PROPERTIES
        INTERFACE_INCLUDE_DIRECTORIES ${NETCOMM_HEADERS}
    ...
    fpgashim::fpgashim
    PROPERTIES
        IMPORTED_LOCATION ${FPGASHIM_LIBRARY}
    )
    ...
    canshim::canshim
    PROPERTIES
        IMPORTED_LOCATION ${CANSHIM_LIBRARY}
    )
    ...
    visa::visa
    PROPERTIES
        INTERFACE_INCLUDE_DIRECTORIES ${VISA_HEADERS}
