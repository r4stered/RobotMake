...
function(GetWpiUrlBase base_url_string library_name version)
    ...
    elseif(${library_name} STREQUAL "driver" OR ${library_name} STREQUAL "cpp")
        ...
        if(${FOUND_FUSION_URL} EQUAL -1)
            ...
            set(BASE_URL
                "${base_url_string}/${version}/PlayingWithFusion-${library_name}-${version}-"
            )
        endif()
    elseif(
        ...
        set(STATIC_STRING "")
        set(BASE_URL "${base_url_string}/${library_name}/${version}/${library_name}-${version}-")
    elseif(${library_name} STREQUAL "photonlib" OR ${library_name} STREQUAL "photontargeting")
        set(BASE_URL
            "${base_url_string}/${library_name}-cpp/${version}/${library_name}-cpp-${version}-"
        )
    else()
        set(BASE_URL
