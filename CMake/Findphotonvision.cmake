...
find_package_handle_standard_args(photonvision DEFAULT_MSG PHOTONLIB_HEADERS
                                  PHOTONLIB_LIBRARY PHOTONTARGETING_HEADERS PHOTONTARGETING_LIBRARY)

mark_as_advanced(PHOTONLIB_HEADERS PHOTONLIB_LIBRARY PHOTONTARGETING_HEADERS PHOTONTARGETING_LIBRARY)
...
if(PHOTONVISION_FOUND AND NOT TARGET photonvision::photonvision)
  ...
  if(WIN32)
    set_target_properties(
      photonlib::photonlib
      PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${PHOTONLIB_HEADERS}
                 IMPORTED_LOCATION ${PHOTONLIB_DLL}
                 IMPORTED_IMPLIB ${PHOTONLIB_LIBRARY})
      set_target_properties(
      photontargeting::photontargeting
      PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${PHOTONTARGETING_HEADERS}
  ...
  target_link_libraries(photonvision INTERFACE photonlib::photonlib photontargeting::photontargeting)
endif()
