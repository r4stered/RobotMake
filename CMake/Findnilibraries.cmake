...
if(NILIBRARIES_FOUND AND NOT TARGET nilibraries::nilibraries)
    ...
    set_target_properties(fpgashim::fpgashim PROPERTIES IMPORTED_LOCATION ${FPGASHIM_LIBRARY})

    add_library(canshim::canshim SHARED IMPORTED)

    set_target_properties(canshim::canshim PROPERTIES IMPORTED_LOCATION ${CANSHIM_LIBRARY})

    add_library(visa::visa SHARED IMPORTED)

    set_target_properties(
        visa::visa
        PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${VISA_HEADERS} IMPORTED_LOCATION ${VISA_LIBRARY}
    )
