...
find_package_handle_standard_args(
  rev DEFAULT_MSG REVDRIVER_HEADERS REVDRIVER_LIBRARY REVCPP_HEADERS
  REVCPP_LIBRARY)

mark_as_advanced(REVDRIVER_HEADERS REVDRIVER_LIBRARY REVCPP_HEADERS
                 REVCPP_LIBRARY)
...
if(REV_FOUND AND NOT TARGET rev::rev)
  ...
  if(WIN32)
    set_target_properties(
      revdriver::revdriver
      PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${REVDRIVER_HEADERS}
                 IMPORTED_LOCATION ${REVDRIVER_DLL}
                 IMPORTED_IMPLIB ${REVDRIVER_LIBRARY})
    set_target_properties(
      revcpp::revcpp
      PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${REVCPP_HEADERS}
    ...
    set_target_properties(
      revcpp::revcpp PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${REVCPP_HEADERS}
