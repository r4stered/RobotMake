...
cmake_path(GET choreo_headers_SOURCE_DIR PARENT_PATH choreo_FIXED_PATH)
...
find_package_handle_standard_args(choreo DEFAULT_MSG CHOREO_HEADERS CHOREO_LIBRARY)
...
if(CHOREO_FOUND AND NOT TARGET choreo::choreo)
    ...
    if(WIN32)
        set_target_properties(
            choreo::choreo
            PROPERTIES
                INTERFACE_INCLUDE_DIRECTORIES ${CHOREO_HEADERS}
